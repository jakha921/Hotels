...
from hotels.serializers import GuestsSerializer, RoomSerializer, HotelsSerializer, descriptionSerializer
...
class ChangeRoomsView(generics.RetrieveUpdateDestroyAPIView):
...
class ChangeHotelsView(generics.RetrieveUpdateDestroyAPIView):

    queryset = Hotels.objects.all()
    serializer_class = HotelsSerializer
    permission_classes = (IsAdminUser, )

class GetDescriptionView(generics.ListAPIView):

    queryset = description_list.objects.all()
    serializer_class = descriptionSerializer
    permission_classes = (IsAdminUser, )

class ChangeDescriptionView(generics.RetrieveUpdateDestroyAPIView):
