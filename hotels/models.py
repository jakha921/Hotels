...
class Hotels(models.Model):
    ...
    adress_text = models.CharField(max_length=120)      # I.Karimov ko`chasi 74/2
    adress_google = models.CharField(max_length=50)     # 40.11732598234071, 65.35481219380598
...
class Rooms(models.Model):
    ...
    book_room = models.CharField(max_length=5, default='Free')
...
class description_list(models.Model):
    room = models.ForeignKey(Rooms, on_delete=models.CASCADE, related_name='description')
...
class Guests(models.Model):
    hotel_name_number = models.ForeignKey(
        Rooms, on_delete=models.CASCADE, null=False)
    date_from = models.DateTimeField(default=today)
    # time      = models.TimeField(default=today)
    date_to = models.DateTimeField(default=tomorrow)
    # time_to = models.TimeField(default=today)
